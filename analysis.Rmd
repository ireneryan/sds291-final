...
We first attempted a correlation matrix using the following code, which was unsuccessful:
```{r, eval=FALSE} 
library(car)
collegescorecard%>%
...
Next we attempted a correlation matrix using the following code, which was successful, but the number of variables made the plot difficult to read.
