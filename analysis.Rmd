...
Attempting another kind of selection:
```{r}
library(leaps)
full <- lm(MN_EARN_WNE_P10~MN_EARN_WNE_P10~MD_FAMINC+SCH_DEG+ADM_RATE_ALL+C150_4+HIGHDEG+TUITFTE+TUITIONFEE_IN+SAT_AVG+GRAD_DEBT_MDN_SUPP+COSTT4_A+PFTFAC+PCTPELL+NPT4_PUB+PCTFLOAN+RPY_3YR_RT_SUPP, data=collegescorecard)
null <- lm(MN_EARN_WNE_P10~1, data=collegescorecard)
step(null, data=collegescorecard, scope=list(lower=null, upper=mod1),
